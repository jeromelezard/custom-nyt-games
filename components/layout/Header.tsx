...
export default function Header({ session }: { session: BetterAuthSession | null }) {
    return (
        <header className="flex flex-col items-center w-full mb-6 text-center transition-all pt-3">
            <div className="flex items-center gap-2 mb-2 pb-2 px-4 ">
                <Link href={`/`} className="-mr-1 h-10 w-10 ">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="fill-foreground">
                ...
                <h1 className="text-xl font-bold uppercase px-2 ">Custom Nyt Games</h1>
